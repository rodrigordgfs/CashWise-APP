...
export const SideBarDesktop = () => {
  ...
  return (
    <aside
      ...
      } transition-all duration-300 overflow-hidden flex-col border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 hidden md:flex h-[calc(100vh-3.5rem)]`}
    >
